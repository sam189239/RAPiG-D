...
def imu_integrator():
    ...
    #############################
    #
    data_indx = 0# index of variable to integrate
    ...
    while True:
        ...
        while True:
            try:
                ...
                mx,my,mz = 0,0,0 # read and convert AK8963 magnetometer data
...
if __name__ == '__main__':
    if not start_bool:
        ...
        if not old_vals_bool:
            ...
            np.save('acc_cal_coeff.npy', accel_coeffs)
        else:
        
            accel_coeffs = np.load('acc_cal_coeff.npy')
