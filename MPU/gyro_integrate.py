...
if __name__ == '__main__':
    if not start_bool:
        ...
        ###################################
        #
        input("Press Enter and Rotate Gyro 90 degrees")
        ...
        axs[0].set_title('Gyroscope Integration over 90$^\circ$ Rotation',
                         fontsize=18)
        fig.savefig('gyroscope_integration_90deg_rot.png',dpi=300,
